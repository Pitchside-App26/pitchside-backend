...
var OFFERS_FALLBACK = [
  {
    ...
    is_featured: true,  is_active: true, new_customers_only: true, is_spreadex: false,
    min_deposit: '£10', wagering: '1×', min_odds: '1/5', expiry: '30 days',
    terms_summary: 'New customers only. 18+. T&Cs apply.',
    ukgc_licence: '39563', affiliate_url: 'https://www.bet365.com/',
    badge_color: '#0070CC', accent_color: 'linear-gradient(90deg,#0070CC,#0050A0)',
    sort_order: 1
  },
  {
    id: 2, operator_name: 'Sky Bet', offer_type: 'welcome',
    title: 'Bet £5, Get £20 in Free Bets',
    subtitle: 'New customers only. Min deposit £5.',
    is_featured: false, is_active: true, new_customers_only: true, is_spreadex: false,
    min_deposit: '£5', wagering: '1×', min_odds: '1/2', expiry: '7 days',
    terms_summary: 'New customers only. 18+. T&Cs apply.',
    ukgc_licence: '38718', affiliate_url: 'https://www.skybet.com/',
    badge_color: '#0C2340', accent_color: 'linear-gradient(90deg,#0C2340,#091929)',
    sort_order: 2
  },
  {
    ...
    is_featured: false, is_active: true, new_customers_only: true, is_spreadex: false,
    min_deposit: '£5', wagering: 'N/A', min_odds: '1/5', expiry: 'Ongoing',
    terms_summary: 'New UK customers. Max refund £20. 18+.',
    ukgc_licence: '44540', affiliate_url: 'https://www.paddypower.com/',
    badge_color: '#007A3D', accent_color: 'linear-gradient(90deg,#007A3D,#005C2E)',
    sort_order: 3
  },
  {
    ...
    is_featured: false, is_active: true, new_customers_only: true, is_spreadex: false,
    min_deposit: '£10', wagering: '1×', min_odds: '1/2', expiry: '28 days',
    terms_summary: 'New customers only. 18+. T&Cs apply.',
    ukgc_licence: '39225', affiliate_url: 'https://www.williamhill.com/',
    badge_color: '#83002A', accent_color: 'linear-gradient(90deg,#83002A,#5E001F)',
    sort_order: 4
  },
  {
    id: 5, operator_name: 'Betfair', offer_type: 'enhanced_odds',
    title: 'Enhanced Odds on Selected Markets',
    subtitle: 'Boosted prices on top matches daily.',
    is_featured: false, is_active: true, new_customers_only: false, is_spreadex: false,
    min_deposit: 'N/A', wagering: 'N/A', min_odds: 'N/A', expiry: 'Daily',
    terms_summary: '18+. T&Cs apply. Selected markets only.',
    ukgc_licence: '39470', affiliate_url: 'https://www.betfair.com/',
    badge_color: '#D4881A', accent_color: 'linear-gradient(90deg,#F5A623,#D4881A)',
    sort_order: 5
  },
  {
    ...
    is_featured: false, is_active: true, new_customers_only: true, is_spreadex: false,
    min_deposit: '£5', wagering: '1×', min_odds: '1/2', expiry: '30 days',
    terms_summary: 'New customers only. 18+. T&Cs apply.',
    ukgc_licence: '44548', affiliate_url: 'https://www.coral.co.uk/',
    badge_color: '#004B91', accent_color: 'linear-gradient(90deg,#004B91,#003570)',
    sort_order: 6
  }
];
...
function _buildCardHtml(offer) {
  var url        = _esc(offer.affiliate_url || '#');
  var color      = offer.badge_color || '#1A1714';
  var accent     = offer.accent_color || 'var(--ink)';
  var badgeBg    = hexToRgba(color, 0.1);
  var typeLabel  = _OFFER_TYPE_LABELS[offer.offer_type] || (offer.offer_type || '');
  var newBadge   = offer.new_customers_only
    ? '<span class="oc-new-badge">New Customer</span>' : '';
  ...
  var terms = '<div class="oc-terms">' +
    _termCell('Min Deposit', offer.min_deposit) +
    _termCell('Wagering',    offer.wagering) +
    _termCell('Min Odds',    offer.min_odds) +
    _termCell('Expires',     offer.expiry) +
    '</div>';
  ...
  return spreadexBanner +
    '<div class="offer-card">' +
      ...
      '<div class="oc-body">' +
        '<div class="oc-hdr">' +
          '<div>' +
            '<div class="oc-op">' + _esc(offer.operator_name) + newBadge + '</div>' +
      ...
      '</div>' +
      '<div class="oc-foot">' +
        '<span class="oc-tc">' + _esc(offer.terms_summary) + '</span>' +
        '<div class="ukgc"><div class="ukgc-dot"></div>UKGC ' + _esc(offer.ukgc_licence) + '</div>' +
      '</div>' +
    '</div>';
}
